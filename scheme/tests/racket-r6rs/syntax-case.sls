...
(library (yuni scheme tests racket-r6rs syntax-case)
  (export run-syntax-case-tests)
  (import (for (yuni scheme r6rs) run expand)
          (rename (only (yuni scheme r6rs base) cons) (cons kons)) ; for free-identifier=?
